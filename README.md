...
Each page contains a quick "get in touch" button to allow for a swift move to contact. This is also the case under the "call to action" on the homepage with two buttons referencing the teaching and conducting page. 

"Get in touch" button to entice visitors to get in contact quickly<br>
![Get in Touch button](./assets/images/Readme%20screenshots/Mobile-user-step-1-min-cropped.png "Get in Touch button")

## hero images containing quick page info
Simple layout and headers that draw the eye allow for showing visitors the main message of the page within the first seconds of visit. Following the mindset of "less is more". 

Quick information headers<br>
![Quick information header](./assets/images/Readme%20screenshots/Page-header-with-brief-information.png "Quick information header")
...
Although Bert Ridder does not have his own social media pages at the moment, the social links were added to ensure they could be used towards the future. Especially when linking in the future to audio and video materials online, these will be useful.

Socials in the footer<br>
![Socials in the footer](./assets/images/Readme%20screenshots/Footer-socials.png "Socials in the footer")

## Contact webform (and ease of contact with phone and email)
Essential for the functionality of Bert Ridder his website is the ability to get in contact with him. Therefore the options that are available are clearly indicated. Whether the visitor has a preference for a call (especially for last minute requests), email from their own email provider or utilise the contact webform, they can choose. This is the page where the "Get in Touch" buttons lead to and it has been kept in line with the rest of website, simple and to the point. (concerning the icons, it has been considered to use the 'whatsapp' image rather then the phone icon. Reason for sticking with the phone icon is the on average older population in the classical music industry)

Ease of contact, several options<br>
![Ease of contact, several options](./assets/images/Readme%20screenshots/Contact-form-and-contact-details.png "Ease of contact, several options")

## Thank you page (acknowledgement of form completion)
Similar to the importance of being able to contact Bert for his availability, it is important to acknowledge the visitor for their effort in reaching out. Therefore a thank you page will appear whenever the contact webform is used. Thanking the visitor for reaching out, providing further options of contact and a link back to the homepage.
...
| --- | --- | --- |
| [Ezgif](https://ezgif.com/webp-to-jpg) | Hero images | Tool to convert image webp to jpg |
| [Cloudconvert](https://cloudconvert.com/avif-to-jpg) | Hero images | Tool to convert image avif to jpg |
| [Online PNG tools](https://onlinepngtools.com/resize-png) | READme | Resizing PNG files |
| [Favicon generator](https://www.favicon.cc/) | Favicon | creating custom Favicon |
| [Font Awesome](https://fontawesome.com/) | Across website | Inspiration for icons |
| [Miro](https://miro.com/) | Wireframing | Creating original site design |
...
| Source | Location | Notes |
| --- | --- | --- |
| [W3schools](https://www.w3schools.com/) | Across website | HTML & CSS funcionality info |
| [Stack Overflow](https://stackoverflow.com/) | Across website | HTML & CSS funcionality info |
...
| [ChatGPT](https://openai.com/chatgpt/) | Across website | HTML & CSS funcionality info |
| [Youtube](https://www.youtube.com/) | Across website | HTML & CSS funcionality info |
| [Love running](https://mjridder.github.io/love-running/signup.html) | Across website | website inspiration |
| [Gitaarles bij Nigel Schat](https://gitaarlesbijnigel.nl/contact) | Across website | website inspiration |
...
| Source | Location | Notes |
| --- | --- | --- |
| [Samen Voorwaarts](https://www.samenvoorwaarts.nl/) | Conducting | Bert experience |
| [Muziek vereniging Zijpe](https://muziekverenigingzijpe.nl/) | Conducting | Bert experience |
